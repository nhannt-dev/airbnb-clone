...
import { Modal, Heading, CategoryInput, CountrySelect, Counter, ImgUpload, Input } from '../components'
    ...
    if (step === STEPS.IMAGES) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <ImgUpload value={imageSrc} onChange={(value) => setCustomValue('imageSrc', value)} />
            </div>
        )
    }
    ...
    if (step === STEPS.PRICE) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <Input type='number' id='price' label='Price' formatPrice disabled={isLoading} register={register} errors={errors} required />
            </div>
        )
    }
